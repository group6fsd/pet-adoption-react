      ...
      <div className="container">
        <div className="w-full flex justify-center">
          <div className="relative">
            ...
            <a href="/category" className="bg-orange-500 px-2 py-1 text-white text-sm rounded-lg shadow-lg absolute top-3/4 left-1/2 -translate-x-1/2 -translate-y-10/12 lg:text-2xl lg:py-2 lg:px-4 md:text-xl">
