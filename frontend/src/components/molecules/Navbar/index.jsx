    ...
    <header className="bg-transparent fixed w-full top-0 left-0 items-center z-10">
      <div className="container">
        <div className="flex items-center justify-between relative">
          <div className="px-4">
            <a href="#home" className="font-bold text-lg text-white block py-6 lg:text-2xl">
              Pet Adoption
            </a>
          </div>
          <div className="flex items-center px-4">
            ...
            <nav id="nav-menu" className="hidden absolute py-5 bg-orange-500 bg-opacity-80 shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block lg:static lg:max-w-full lg:shadow-none lg:rounded-none lg:bg-transparent">
              <ul className="block lg:flex">
                <li className="group">
                  <a href="#home" className="text-base text-white group-hover:text-fuchsia-950 py-2 mx-8 flex lg:text-lg">
                    Home
                  </a>
                </li>
                <li className="group">
                  <a href="/src/pages/Pets.html" className="text-base text-white group-hover:text-fuchsia-950 py-2 mx-8 flex lg:text-lg">
                    Find a Pet
                  </a>
                </li>
                <li className="group">
                ...
                <li className="group">
                  <a href="/src/pages/RegisterPage.html" className="text-base text-white group-hover:text-fuchsia-950 py-2 mx-8 flex lg:text-lg">
                    Sign Up
                  </a>
                </li>
                <li className="group">
                  <a href="/src/pages/LoginPage.html" className="text-base text-white group-hover:text-fuchsia-950 py-2 mx-8 flex lg:text-lg">
                    Sign In
                  </a>
                </li>
              </ul>
