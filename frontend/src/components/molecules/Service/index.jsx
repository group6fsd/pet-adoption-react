      ...
      <section className="bg-[#fafcff] pt-12 pb-32">
        <div className="container">
          <div className="w-full px-4 text-center mb-10">
            <h4 className="font-[Poppins] font-bold text-3xl mb-10 sm:text-4xl lg:text-5xl">
              Our Services
            </h4>
          </div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:1/3">
              <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-10 dark:bg-slate-800">
                ...
                <div className="px-6 py-8">
                  <h3>
                    <Link to="/pet">
                      <p className="block mb-3 font-semibold text-xl text-center hover:text-orange-500">
                        Adopt A pet
                      </p>
                    </Link>
                  </h3>
                  <p className="font-medium text-base mb-6 text-center">
                    We provide an adoption pet system that you can find it here
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-10 dark:bg-slate-800">
                ...
                <div className="px-6 py-8">
                  <h3>
                    <a
                      href="#"
                      className="block mb-3 font-semibold text-xl text-center hover:text-orange-500"
                    >
                      Donation
                    </a>
                  </h3>
                  <p className="font-medium text-base mb-6 text-center">
                    Donation system that you can donate pets with money or foods
                  </p>
                </div>
              </div>
            </div>
